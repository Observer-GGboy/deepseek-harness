...
| [session-import.md](session-import.md) | safe local Codex/Claude Code discovery, stable-prefix capture, neutral snapshots, deterministic atomic publication, and continuation boundaries |
