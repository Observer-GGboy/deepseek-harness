...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionImportLocal: 'session-import.md',
  sessionImports: 'session-import.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ForeignSessionProvider: 'session-import.md',
  ForeignSessionSourceKind: 'session-import.md',
  SessionImportCaptureRequest: 'session-import.md',
  SessionImportCaptureValue: 'session-import.md',
  SessionImportCommitRequest: 'session-import.md',
  SessionImportCommitValue: 'session-import.md',
  SessionImportDiscoverRequest: 'session-import.md',
  SessionImportDiscoverValue: 'session-import.md',
  SessionImportDiscardRequest: 'session-import.md',
  SessionImportDiscardValue: 'session-import.md',
  SessionImportOptionsValue: 'session-import.md',
  SessionImportResult: 'session-import.md',
